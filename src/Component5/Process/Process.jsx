...
const Process = () => {
  ...
  return (
    <section className='mx-2 sm:mx-3 md:mx-5 lg:mx-2 xl:mx-5 2xl:mx-8 3xl:mx-[50px] rounded-md lg:rounded-[20px] bg-[url("/images/process-bg.png")] bg-cover bg-center bg-no-repeat py-16 md:py-20 lg:py-28 relative z-20'>
            ...
            <div className='space-y-7 md:space-y-[74px] lg:space-y-10 xl:space-y-[74px] mt-8'>
              <div className='process-box group inline-block'>
                <div className='flex gap-4 sm:gap-7 items-center relative'>
                  ...
                  />
                  <div className='process-icon size-14 sm:size-[100px] rounded-full bg-white flex items-center justify-center shadow-shade relative z-10 before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-gradient-to-t before:to-PrimaryColor-0 before:from-PrimaryColor2-0 before:rounded-full before:-z-10 before:scale-0 before:transition-all before:duration-500 group-hover:scale-100 group-active:before:scale-100'>
                    <img
                      src={processIcon}
                      draggable={false}
                      alt='Process Icon'
