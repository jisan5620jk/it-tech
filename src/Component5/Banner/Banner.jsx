...
const Banner = () => {
  return (
    <div className='bg-BodyBgDark4-0 px-2 sm:px-3 md:px-5 lg:px-2 xl:px-5 2xl:px-8 3xl:px-[50px]'>
      <section className="rounded-md lg:rounded-[20px] bg-[url('/images/hero-bg2.png')] bg-cover bg-bottom bg-no-repeat h-[600px] sm:h-[780px] md:h-[1560px] lg:h-[700px] xl:h-[900px] flex items-center relative z-20 overflow-hidden">
