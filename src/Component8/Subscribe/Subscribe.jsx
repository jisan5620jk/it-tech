...
const Subscribe = () => {
  return (
    <section className="bg-[url('/images/subscribe-bg.jpg')] bg-no-repeat bg-center bg-cover bg-fixed pt-40 pb-[176px] relative z-10 before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-gradient-to-t before:from-[#04142449] before:via-[#041424b7] before:to-[#041424f6] before:to-90% before:-z-10">
