...
const WhyChoose = () => {
  return (
    <section>
      <div className='bg-[url("images/bg-1-1.jpg")] bg-cover bg-center bg-no-repeat pt-16 md:pt-20 lg:pt-28'>
        <div className='Container'>
          <div className='grid grid-cols-1 gap-10 lg:gap-0 lg:grid-cols-2 items-center relative'>
            <div className='absolute top-14 -right-[158px] animate-wiggle hidden md:block'>
              <img
                src={featureShape}
                draggable='false'
                alt='Shape'
      ...
      <div className='bg-[url("images/bg-2.jpg")] bg-cover bg-center bg-no-repeat pb-10 sm:pb-16 md:pb-[90px]'>
        <Testimonial />
        <Marquee />
      </div>
    </section>
