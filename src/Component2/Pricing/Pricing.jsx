...
import pricingShape from '/images/pricing-robot.png';
      ...
      <div className='Container'>
        <div className='grid grid-cols-1 lg:grid-cols-3'>
          <div className='col-span-1'>
            ...
            <div
              className='toggle-container inline-flex items-center gap-2 py-[15px] px-8 bg-white rounded-full bg-opacity-30 border-2 border-white'
              onClick={togglePlans}
            >
