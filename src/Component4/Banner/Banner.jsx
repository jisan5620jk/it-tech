...
const Banner = () => {
  return (
    <section className="bg-[url('/images/hero_bg.png')] bg-cover bg-center bg-no-repeat pt-32 md:pt-36 lg:pt-40 xl:pt-[228px] pb-20 md:pb-24 lg:pb-28 xl:pb-[212px] flex items-center relative z-20 overflow-hidden">
