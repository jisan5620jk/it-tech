  ...
  return (
    <div className='group bg-BodyBg-0 rounded-lg py-9 px-[30px] relative z-10 overflow-hidden transition-all duration-500 group-hover:text-white before:absolute before:top-0 before:right-0 before:bg-[#fdf6f0] before:w-0 before:h-full before:transition-all before:duration-300 before:ease-linear before:-z-10 hover:before:w-full hover:before:left-0'>
      <div className='flex gap-7 items-center'>
        ...
        <h4 className='flex-1 font-Rajdhani leading-7 font-semibold text-SecondaryColor-0 text-2xl'>
          {provideBoxTitle}
        </h4>
      </div>
