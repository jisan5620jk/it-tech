...
const Provide = () => {
  return (
    <section className='pt-28 relative bg-white'>
      ...
      <div className='mt-[46px] relative z-10 overflow-hidden bg-[url(/images/service-bg21.png)] bg-cover bg-center max-w-[1490px] w-full mx-auto rounded-lg py-[100px]'>
        ...
        <div className='Container'>
          <ul className='grid items-center grid-cols-3 gap-8 mt-7'>
            <li className='flex items-center gap-7 bg-BodyBg-0 rounded-lg pr-14 pl-[30px] py-9 relative z-10 overflow-hidden transition-all duration-500 group-hover:text-white before:absolute before:top-0 before:right-0 before:bg-[#fdf6f0] before:w-0 before:h-full before:transition-all before:duration-300 before:ease-linear before:-z-10 hover:before:w-full hover:before:left-0'>
              <div className='size-[72px] rounded-lg bg-BodyBg2-0 relative z-10 flex items-center justify-center overflow-hidden'>
                <img
                  src={itemIcon}
                  draggable={false}
                  alt='Icon'
