...
const WhyChoose = () => {
  return (
    <section className='bg-[url("/images/why-choose.webp")] bg-cover bg-center bg-no-repeat py-16 md:py-20 lg:py-28 relative z-10'>
      <div className='Container'>
        <div className='grid grid-cols-1 gap-10 lg:gap-[190px] lg:grid-cols-2 items-end relative'>
          <div className='relative'>
            <div className='absolute -bottom-[72px] -right-9'>
