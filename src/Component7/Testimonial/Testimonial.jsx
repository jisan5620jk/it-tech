...
const Testimonial = () => {
  ...
  return (
    <section className='testimonial pt-16 md:pt-20 lg:pt-[120px] pb-16 md:pb-20 lg:pb-[192px] bg-[url(/images/testimonial.png)] bg-no-repeat bg-cover bg-bottom relative z-20 overflow-hidden'>
