...
const TeamInnerCard = ({
  ...
  return (
    <div className="group relative">
      ...
      <div className="bg-BodyBg-0 relative transition-all duration-500 [clip-path:polygon(0_0,_100%_0%,_100%_100%,_50%_84%,_0_100%)] rounded-md text-center pt-[22px] pb-10 rounded-b-md before:absolute before:bottom-0 before:left-0 before:w-full before:h-1/2 before:bg-[url('/images/team-shape.png')] before:bg-no-repeat before:bg-cover before:-z-10 before:rounded-md group-hover:bg-PrimaryColor-0 group-hover:-mt-9">
        ...
        <ul className="flex gap-4 justify-center mb-[6px]  transition-all duration-500 opacity-0 group-hover:mb-7 group-hover:opacity-100 group-hover:mt-[14px]">
          <li>
            <Link to={"/"}>
