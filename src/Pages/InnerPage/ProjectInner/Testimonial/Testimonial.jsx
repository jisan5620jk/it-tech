...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url('/images/teasti-bg-2.jpg')] bg-cover bg-center relative z-10 overflow-hidden px-4 sm:px-8 lg:px-2 xl:px-16 2xl:px-14 3xl:px-[100px] py-16 md:py-20 lg:py-[120px] rounded-b-lg lg:rounded-b-2xl">
