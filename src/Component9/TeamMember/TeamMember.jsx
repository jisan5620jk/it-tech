...
const TeamMember = () => {
  ...
  return (
    <section className='bg-BodyBgDark6-0 pt-16 pb-0 md:pt-20 lg:pt-28 relative z-10'>
      ...
      <div className='h-[120px] w-full bg-BorderColor5-0 absolute bottom-0 left-0 -z-10 inline-block'></div>
    </section>
  );
};
